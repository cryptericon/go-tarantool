...
func (fut *Future) fillSearch(enc *msgpack.Encoder, spaceNo, indexNo uint32, key interface{}) error {
	var err error
	if err = enc.EncodeUint64(KeySpaceNo); err != nil {
		return err
	}
	if err = enc.EncodeUint64(uint64(spaceNo)); err != nil {
		return err
	}
	if err = enc.EncodeUint64(KeyIndexNo); err != nil {
		return err
	}
	if err = enc.EncodeUint64(uint64(indexNo)); err != nil {
		return err
	}
	if err = enc.EncodeUint64(KeyKey); err != nil {
		return err
	}
...
func (fut *Future) fillIterator(enc *msgpack.Encoder, offset, limit, iterator uint32) {
	_ = enc.EncodeUint64(KeyIterator)
	_ = enc.EncodeUint64(uint64(iterator))
	_ = enc.EncodeUint64(KeyOffset)
	_ = enc.EncodeUint64(uint64(offset))
	_ = enc.EncodeUint64(KeyLimit)
	_ = enc.EncodeUint64(uint64(limit))
}
...
func (fut *Future) fillInsert(enc *msgpack.Encoder, spaceNo uint32, tuple interface{}) error {
	...
	if err = enc.EncodeUint64(KeyTuple); err != nil {
		return err
	}
...
func (conn *Connection) UpsertAsync(space interface{}, tuple interface{}, ops interface{}) *Future {
	...
	return future.send(conn, func(enc *msgpack.Encoder) error {
		...
		if err = enc.EncodeUint64(KeyDefTuple); err != nil {
			return err
		}
		return enc.Encode(ops)
	})
...
func (conn *Connection) CallAsync(functionName string, args interface{}) *Future {
	...
	return future.send(conn, func(enc *msgpack.Encoder) error {
		...
		if err = enc.EncodeUint64(KeyFunctionName); err != nil {
			return err
		}
		if err = enc.EncodeString(functionName); err != nil {
			return err
		}
		if err = enc.EncodeUint64(KeyTuple); err != nil {
			return err
...
func (conn *Connection) EvalAsync(expr string, args interface{}) *Future {
	...
	return future.send(conn, func(enc *msgpack.Encoder) error {
		...
		if err = enc.EncodeUint64(KeyExpression); err != nil {
			return err
		}
